...
static size_t strlcat(char *dest, const char *src, size_t bufferSize) {
 ...
 * for them would go.
 */
static int loadTokens(char **tokens, int maxtokens, char *buf, int verbosity) {
	char **loadp;
	int pushChar = 0;
...
int parseLine( FILE *ifp, char **tokens, int maxtokens, char *buf, int bufsiz, int verbosity ) {
